...
@pytest.mark.parametrize(
    ...
    (
        ('/v1/labels',),
        ('/v1/labels?addresses=0x8da0d80f5007ef1e431dd2127178d224e32c2ef4',),
    ),
    ids=(
        'without query param filter',
        'with query param filter',
    )
)
async def test_get_labels_does_not_return_not_reviewed_entries_from_db(
        cli: TestClient,
        sa_engine: Engine,
        url: str,
) -> None:
